...
function ProductList() {
    ...
    const [addedToCart, setAddedToCart] = useState({}); // State to store whether a plant object has been added to cart
...
const handleAddToCart = (product) =>
    {
        ...
        setAddedToCart((prevState) =>
            (
                {
                    ...prevState,
                    [product.name]: true, //value of 'true' indicates the particular plant object has been added.
                }
            )
        );
    };
    return (
        ...
        {!showCart? (
        <div >
            {plantsArray.map((obj,index) =>
                (
                    <div key={index}>
                        <h1 className="product-grid">{obj.category}</h1>
                        <div className='product-list'>
                            {obj.plants.map((plant, plantIndex) =>
                                (
